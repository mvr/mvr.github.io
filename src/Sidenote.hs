...
-- This could be implemented more concisely, but this is more clear.
...
filterInline (Note blocks) = do
  -- '{-}' differentiates between margin note and side note.
  -- '{.}' indicates whether to leave the footnote untouched.
