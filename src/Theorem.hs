...
data Tag = Definition | Lemma | Proposition | Theorem | Proof | Claim | Example | Assumption | Remark
    deriving (Show, Eq)
...
filterThms :: Pandoc -> Pandoc
filterThms = topDown ((toList . convertBlock) =<<)
